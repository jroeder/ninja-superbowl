...
public class ExhibitionController extends AbstractEntityController {
	...
	public Result registerExhibitionConfirmation(@JSR303Validation ExhibitionForm exhibitionForm, Session session,
		...
		logger.info("ExhibitionController.registerExhibitionConfirmation -> Context......: " + context.getRequestPath());
		logger.info("ExhibitionController.registerExhibitionConfirmation -> Violations...: " + validation.hasViolations());
