...
public class BowlController extends AbstractBowlController {
	...
	public Result editBowlCompletion(Session session, Context context) {
		...
		logger.info("BowlController.editBowlCompletion -> Session id...: " + session.getId());
		logger.info("BowlController.editBowlCompletion -> Context......: " + context.getRequestPath());
	...
	public Result modifyBowl(Session session, Context context, @Param("bowlId") String bowlId) {
		logger.info("BowlController.modifyBowl -> Session.......id:. " + session.getId());
		logger.info("BowlController.modifyBowl -> Session....empty: " + session.isEmpty());
		logger.info("BowlController.modifyBowl -> Bowl..........id: " + bowlId);
