...
public class TimberController extends AbstractEntityController {
	...
	public Result registerTimber(Session session, Context context, @Param("emptyTable") Boolean emptyTable,
		...
		if (geoRegionCode.isEmpty() && (botanicSystemOrder == null || botanicSystemOrder.isEmpty())
			...
			logger.info("~~~~~~~~~~~~~~~~~~~~~~~~");
			timberIndex = lookupMaxTimberIndex(DEFAULT_GEOREGION_ID);
			...
			if (!geoRegionCode.isEmpty() && (botanicSystemOrder == null || botanicSystemOrder.isEmpty())
				...
				logger.info("~~~~~~~~~~~~~~~~~~~~~~~~~~");
				geoRegionDto = geoRegionService.getGeoRegionByCode(geoRegionCode);
				timberIndex = lookupMaxTimberIndex(geoRegionDto.getId());
				selectedGeoRegionIndex = geoRegionDto.getIndex();
		...
		logExtraData(emptyTable, geoRegionList, botanicSystemList, botanicSystemOrderList, botanicSystemFamilyList,
				...
				selectedBotanicSystemSubFamily, timberIndex);
	...
	/**
	 * Select the maximum {@code Timber} index by {@code GeoRegion} identifier
	 * and return the {@code Timber} index incremented by 1.
	 *
	 * @param geoRegionId
	 *            the {@code GeoRegion} identifier
	 * @return the maximum {@code TImber} index by {@code GeoRegion} incremented
	 *         by 1
	 */
	private final Integer lookupMaxTimberIndex(Long geoRegionId) {
		Integer maxTimberIndex = timberService.getTimberMaxIndexByGeoRegionId(geoRegionId);
		return ++maxTimberIndex;
	}
	 ...
	 * @param timberIndex
	 *            the maximum {@code Timber} index by {@code GeoRegion]
	 */
	private final void logExtraData(Boolean emptyTable, List<GeoRegionDto> geoRegionList,
			...
			String selectedBotanicSystemFamily, String selectedBotanicSystemSubFamily, Integer timberIndex) {
		...
		if (isLog) {
			...
			logger.info("TimberController.registerTimber geoRegionListSize..................: {}",
					geoRegionList.size());
			...
			logger.info("TimberController.registerTimber selectedGeoRegionIndex.............: {}",
					selectedGeoRegionIndex);
			logger.info("TimberController.registerTimber selectedGeoRegionCode..............: {}",
					selectedGeoRegionCode);
			logger.info("TimberController.registerTimber selectedBotanicSystemId............: {}",
					selectedBotanicSystemId);
			...
			logger.info("TimberController.registerTimber timberIndex........................: {}", timberIndex);
