...
public class TimberServiceImpl extends AbstractService implements TimberService {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see services.TimberService#getTimberMaxIndexByGeoRegionId(java.lang.Long)
	 */
	@Override
	public Integer getTimberMaxIndexByGeoRegionId(@NotNull Long id) {
		return timberDao.getTimberMaxIndexByGeoRegionId(id);
	}
